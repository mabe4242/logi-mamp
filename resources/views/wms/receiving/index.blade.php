...
@section('title', '入荷する（検品）')
@section('header_title', '入荷')

@section('content')
<div class="page-head">
    <div class="page-title">入荷する（検品）</div>
</div>
...
<div class="card">
    <div class="toolbar">
        <form method="GET" style="display:flex; gap:10px; align-items:center;">
            ...
            <a class="btn" href="{{ route('receiving.index') }}">リセット</a>
        </form>
    ...
    <table class="table">
        ...
        @forelse($plans as $plan)
            <tr>
                ...
                <td>入荷作業中（検品）</td>
                <td>
                    <a class="btn btn--primary" href="{{ route('receiving.show', $plan) }}">検品する</a>
                </td>
            </tr>
        @empty
            <tr><td colspan="5" class="muted">検品対象の入荷予定がありません</td></tr>
        @endforelse
        </tbody>
    </table>
